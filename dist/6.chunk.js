...
/***/ "../../../../../src/app/layout/contest-standing/contest-standing-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contest_standing_component__ = __webpack_require__("../../../../../src/app/layout/contest-standing/contest-standing.component.ts");
...
/***/ "../../../../../src/app/layout/contest-standing/contest-standing.component.html":
...
/***/ "../../../../../src/app/layout/contest-standing/contest-standing.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ContestStandingComponent = (function () {
    function ContestStandingComponent(sanitizer, contestStandingService, contestInfoService) {
        var _this = this;
        ...
        this.search = function (text$) {
            return text$
                ...
                if (term.length < 1) {
                    ...
                    var dict_1 = [];
                    var whiteList_1 = ["TeamName", "School", "NickName",
                        "Coach", "Player1", "Player2", "Player3",];
                    _this.contestStanding.TeamStandings.forEach(function (team) {
                        whiteList_1.forEach(function (attr) {
                            if (attr in team && typeof team[attr] === 'string') {
                                dict_1.push(team[attr]);
                            }
                        });
                    });
                    console.log("dict", dict_1);
    ...
    ContestStandingComponent.prototype.ngOnInit = function () {
        var _this = this;
        var timer = __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_TimerObservable__["TimerObservable"].create(0, 1200);
        this.subscription = timer.subscribe(function () {
            _this.contestStandingService.getContestStanding()
                .subscribe({
            ...
            _this.contestInfoService.getContestInfo()
                .subscribe({
                next: function (result) {
    ...
    ContestStandingComponent.prototype.spanStyle = function (rank) {
        if (!this.contestInfo) {
            return this.sanitizer.bypassSecurityTrustStyle("color:auto");
        }
        var level1 = this.contestInfo.GoldMedalNum;
        var level2 = level1 + this.contestInfo.SilverMedalNum;
        var level3 = level2 + this.contestInfo.BronzeMedalNum;
        if (rank <= level1) {
    ...
    ContestStandingComponent.prototype.popoverText = function (team) {
...
ContestStandingComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        template: __webpack_require__("../../../../../src/app/layout/contest-standing/contest-standing.component.html"),
        providers: [
            __WEBPACK_IMPORTED_MODULE_3__shared_services__["f" /* ContestStandingService */],
            __WEBPACK_IMPORTED_MODULE_3__shared_services__["d" /* ContestInfoService */],
        ]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["c" /* DomSanitizer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["c" /* DomSanitizer */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__shared_services__["f" /* ContestStandingService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__shared_services__["f" /* ContestStandingService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__shared_services__["d" /* ContestInfoService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__shared_services__["d" /* ContestInfoService */]) === "function" && _c || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__contest_standing_component__ = __webpack_require__("../../../../../src/app/layout/contest-standing/contest-standing.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__contest_standing_routing_module__ = __webpack_require__("../../../../../src/app/layout/contest-standing/contest-standing-routing.module.ts");
...
var NameFilterPipe = (function () {
    ...
    NameFilterPipe.prototype.transform = function (teamList, query) {
        return teamList.filter(function (team) {
            var ok = (query == "");
            ["TeamName", "School", "NickName"].forEach(function (attr) {
                if (attr in team && typeof team[attr] === 'string') {
                    ok = ok || team[attr].toLowerCase().indexOf(query.toLowerCase()) > -1;
                }
            });
            ["Coach", "Player1", "Player2", "Player3"].forEach(function (attr) {
                if (attr in team && typeof team[attr] === 'string') {
