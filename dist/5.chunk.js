...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__contest_standing_component__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__contest_standing_routing_module__ = __webpack_require__(793);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared__ = __webpack_require__(122);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NameFilterPipe", function() { return NameFilterPipe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContestStandingModule", function() { return ContestStandingModule; });
...
var NameFilterPipe = (function () {
    ...
    NameFilterPipe.prototype.transform = function (items, query) {
...
var ContestStandingModule = (function () {
    function ContestStandingModule() {
    }
    return ContestStandingModule;
}());
ContestStandingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["i" /* CommonModule */],
            __WEBPACK_IMPORTED_MODULE_5__contest_standing_routing_module__["a" /* ContestStandingRoutingModule */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__contest_standing_component__["a" /* ContestStandingComponent */],
            NameFilterPipe,
        ]
    })
], ContestStandingModule);

//# sourceMappingURL=contest-standing.module.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_TimerObservable__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_startWith__ = __webpack_require__(222);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_debounceTime__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_debounceTime___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_debounceTime__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(221);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContestStandingComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ContestStandingComponent = (function () {
    function ContestStandingComponent(contestStandingService) {
        var _this = this;
        this.contestStandingService = contestStandingService;
        ...
        this.search = function (text$) {
            return text$
                ...
                if (term.length < 2) {
                    ...
                    return _this.contestStanding.TeamStandings
                        .filter(function (t) { return t.TeamName.toLowerCase().indexOf(term.toLowerCase()) > -1; })
                        .slice(0, 10)
    ...
    ContestStandingComponent.prototype.ngOnInit = function () {
        var _this = this;
        var timer = __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_TimerObservable__["TimerObservable"].create(0, 1000);
        this.subscription = timer.subscribe(function () { return _this.contestStandingService.getContestStanding()
            .subscribe({
            next: function (result) {
                ...
                result.StandingsHeader.Problems = result.StandingsHeader.Problems
                    .sort(function (p1, p2) { return p1.ID < p2.ID ? -1 : 1; });
                // order result.TeamStandings by team.Rank
                result.TeamStandings = result.TeamStandings
                    .sort(function (t1, t2) { return t1.Rank < t2.Rank ? -1 : 1; });
                for (var _i = 0, _a = result.TeamStandings; _i < _a.length; _i++) {
                    var t = _a[_i];
                    t.ProblemSummaryInfos = t.ProblemSummaryInfos
                        .sort(function (p1, p2) { return p1.Index < p2.Index ? -1 : 1; });
                }
                _this.contestStanding = result;
            },
            error: function (err) {
                console.error('getContestStanding observer got an error: ', err);
                _this.error = err;
            },
            complete: function () { return console.log('getContestStanding observer got a complete notification'); }
        }); });
    };
    ContestStandingComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    return ContestStandingComponent;
}());
ContestStandingComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-contest-standing',
        template: __webpack_require__(854),
        providers: [__WEBPACK_IMPORTED_MODULE_2__shared_services__["f" /* ContestStandingService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__shared_services__["f" /* ContestStandingService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__shared_services__["f" /* ContestStandingService */]) === "function" && _a || Object])
], ContestStandingComponent);

var _a;
//# sourceMappingURL=contest-standing.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contest_standing_component__ = __webpack_require__(765);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContestStandingRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__contest_standing_component__["a" /* ContestStandingComponent */] }
];
var ContestStandingRoutingModule = (function () {
    function ContestStandingRoutingModule() {
    }
    return ContestStandingRoutingModule;
}());
ContestStandingRoutingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
...
//# sourceMappingURL=contest-standing-routing.module.js.map
